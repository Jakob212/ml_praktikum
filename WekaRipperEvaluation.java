    ...
    public static void main(String[] args) throws Exception {
        ...
        for (String dataset : datasets) {
            ...
            if (data.classAttribute().isNumeric()) {
                ...
                // In WEKA sind die Attributindizes 1-basiert
            ...
            for (int i = 0; i < 15; i++) {
                ...
                // Kopie der Daten erstellen und zufällig mischen (Seed = i)
                ...
                // Kreuzvalidierung (3-fach) auf den Trainingsdaten
                Evaluation evalCV = new Evaluation(train);
                JRip jripCV = new JRip();
                jripCV.setSeed(42);             // fester Seed für den Klassifikator
                jripCV.setOptimizations(2);       // entspricht k = 2 Optimierungsrunden
                jripCV.setFolds(3);               // (analog zu prune_size=0.33 – hier als 3‑Folds für das interne Pruning)
                evalCV.crossValidateModel(jripCV, train, 3, new Random(i));
                double cvAcc = evalCV.pctCorrect() / 100.0;
                cvAccuracies.add(cvAcc);

                // Training des JRip-Klassifikators auf den Trainingsdaten
                JRip jrip = new JRip();
                jrip.setSeed(42);
            ...
            // Ausgabe der Testgenauigkeiten als Matrix (1x15)
